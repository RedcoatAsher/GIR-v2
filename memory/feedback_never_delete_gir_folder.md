...
**Why:** `.gir/` is the project memory bank — it contains MISSION.md, activeContext.md, ESCALATION.md, GIR.modules, and user-owned customization files. Deleting it destroys project state and history.
